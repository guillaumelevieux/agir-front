...
<script setup lang="ts">
  import { RecupererCatalogueGroupesUseCase } from '@/groupes/recupererCatalogueGroupes.usecase';
  ...
  const usecase = new RecupererCatalogueGroupesUseCase(new GroupeRepositoryAxios());
